...
{
  public:
    Unirand(long long seed, int min, int max) 
    : 
    random(
      std::bind(
...
BinSearchTree<ValueType> & BinSearchTree<ValueType>::operator<<(ValueType value)
{
    if(!this->treep) {
        ...
        this->root = this->treep = new typename BinSearchTree<ValueType>::Node(value);
        ...
        if(!this->treep->leftChild()) {
            ...
            this->treep->leftChild(new typename BinSearchTree<ValueType>::Node(value));
        ...
        if(!this->treep->rightChild()) {
            ...
            this->treep->rightChild(new typename BinSearchTree<ValueType>::Node(value));
